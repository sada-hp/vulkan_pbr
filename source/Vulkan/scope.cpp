...
RenderScope& RenderScope::CreateTerrainRenderPass()
{
	VkRenderPassCreateInfo createInfo{};
	std::array<VkAttachmentDescription, 4> attachments;
	...
	std::array<VkAttachmentReference, 3> mat_ref
	{
		VkAttachmentReference{0, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL},
		VkAttachmentReference{1, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL},
		VkAttachmentReference{2, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL}
	...
	std::array<VkAttachmentReference, 3> tex_ref
	{
	...
	::CreateRenderPass(m_LogicalDevice, createInfo, &m_TerrainPass);
...
void RenderScope::Destroy()
{
	...
	if (m_TerrainPass != VK_NULL_HANDLE)
		vkDestroyRenderPass(m_LogicalDevice, m_TerrainPass, VK_NULL_HANDLE);
