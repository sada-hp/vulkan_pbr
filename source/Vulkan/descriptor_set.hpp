...
public:
	...
	DescriptorSetDescriptor& AddSubpassAttachment(uint32_t binding, VkShaderStageFlags stages, VkImageView view, VkImageLayout layout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);

	DescriptorSetDescriptor& AddStorageImage(uint32_t binding, VkShaderStageFlags stages, VkImageView view, VkImageLayout layout = VK_IMAGE_LAYOUT_GENERAL);
